...
resource "null_resource" "docker_build_push" {
  ...
  provisioner "local-exec" {
    ...
    command     = <<-EOT
      ...
      docker tag my-python-app:latest ${data.aws_caller_identity.current.account_id}.dkr.ecr.us-east-1.amazonaws.com/my-app:latest
      docker push ${data.aws_caller_identity.current.account_id}.dkr.ecr.us-east-1.amazonaws.com/my-app:latest
    EOT
  }
}
